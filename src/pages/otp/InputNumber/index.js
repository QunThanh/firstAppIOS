   ...
   const renderInputNumber = (
      <View style={styles.wrapper}>
         ...
         <View style={styles.wrapperHeader}>
            <Text style={styles.title}>{strings.otp.inputNum.header}</Text>
            <View style={styles.wrapperHeader}>
               <Image style={styles.img} source={images.icons.otp} />
               <Text style={styles.description}>{strings.otp.inputNum.desc}</Text>
            </View>
         </View>
         <View style={styles.wrapperInput}>
            <TextInputComponent
               ...
               inputMode="number"
               placeholder={strings.otp.inputNum.placeholder}
            ...
            <TouchableOpacity
               ...
               onPress={() => handleOnPressContinue(number)}
            >
               <Text style={styles.title}>{strings.global.buttonContinue}</Text>
            </TouchableOpacity>
         </View>
      </View>
   );

   return <StackAnimated componentId={componentId} run={run} child={renderInputNumber} />;
}
