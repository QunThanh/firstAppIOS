   ...
   return (
      <View style={styles.wrapper}>
         ...
         <View style={styles.wrapperHeader}>
            <Text style={styles.title}>{strings.otp.verifyOtp.header}</Text>
            <View style={styles.wrapperHeader}>
               <Text style={styles.description}>
                  {strings.otp.verifyOtp.decs} {number}
               </Text>
            </View>
         </View>
         <View style={styles.wrapperInput}>
            ...
            />
            <Pressable style={styles.input} onPress={() => refInput.current.focus()}>
         ...
         <View style={styles.wrapperDec}>
            <Text style={[styles.textDec, styles.blurText]}>{strings.otp.verifyOtp.spanRequestAgain}</Text>
            <TouchableOpacity onPress={handleOnPressRequestAgain}>
               <Text style={styles.textDec}>{strings.otp.verifyOtp.requestAgain}</Text>
            </TouchableOpacity>
         </View>

         <TouchableOpacity activeOpacity={0.5} style={styles.login} onPress={handleOnPressVerifyLogin}>
            <Text style={styles.title}>{strings.otp.verifyOtp.buttonVerify}</Text>
         </TouchableOpacity>
      </View>
   );
}
